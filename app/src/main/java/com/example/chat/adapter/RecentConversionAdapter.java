...
public class RecentConversionAdapter extends RecyclerView.Adapter<RecentConversionAdapter.ConversionViewHolder>{
    ...
    class ConversionViewHolder extends RecyclerView.ViewHolder{
        ...
        void setData(ChatMessage chatMessage){
            binding.imageProfileItemContainerRecentConversion.setImageBitmap(getConversionImage(chatMessage.conversionImage));
            binding.textRecentMessageItemContainerRecentConversion.setText(chatMessage.message);
            binding.textNameItemContainerRecentConversion.setText(chatMessage.conversionName);
